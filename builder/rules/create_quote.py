...
class CreateQuote(Rule):
    ...
    def rule_woman_21_50_car(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.11
    ...
    def rule_woman_41_65_car(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.09
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_woman_66_75_car(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.155
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_man_25_35_car(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.15
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_man_36_60_car(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.12
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_man_61_75_car(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.135
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_woman_21_50_moto(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.25
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_woman_41_65_moto(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.23
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_woman_66_75_moto(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.295
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_man_25_35_moto(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.29
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_man_36_60_moto(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.26
        logging.debug("Quote starting amount: %d", self.quote.amount)
    ...
    def rule_man_61_75_moto(self):
        ...
        self.quote.amount = self.quote.vehicule.value * 100 * 0.275
        logging.debug("Quote starting amount: %d", self.quote.amount)
